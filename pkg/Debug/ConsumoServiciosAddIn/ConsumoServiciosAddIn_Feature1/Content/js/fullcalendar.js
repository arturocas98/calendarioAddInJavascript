...
(function(t) {
		...
		function o(n) {
			...
			return o && t.each(o.split(" "), function() {
				...
				t.each(this.split(","), function(n, r) {
					var l, a, c, d, h, u, g, m;
					"title" == r ? (o = o.add(t("<h2 class='title_calendar' >&nbsp;</h2>")), s = !1) : (e[r] ? l = function() {
						e[r]()
					} : xe[r] && (l = function() {
						e.changeView(r)
	...
	j.prototype = {
		...
		getHtmlRenderer: function(t, e) {
			...
			return i = t + "Html", e && (n = e + z(t) + "Html"), n && (o = s[n]) ? r = s : n && (o = this[n]) ? r = this : (o = s[i]) ? r = s : (o = this[i]) && (r = this), "function" == typeof o ?
			function() {
