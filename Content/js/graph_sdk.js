var MicrosoftGraph = (function (e) {
    ...
    var r = t(function (e) {
        var t = (function (e) {
            ...
            function R(e, r) {
                ...
                return i
                    ? i.done
                        ? ((r[e.resultName] = i.value), (r.next = e.nextLoc), "return" !== r.method && ((r.method = "next"), (r.arg = t)), (r.delegate = null), f)
                        : i
            ...
            return (
                ...
                (A.prototype = {
                    ...
                    delegateYield: function (e, r, n) {
                        return (this.delegate = { iterator: D(e), resultName: r, nextLoc: n }), "next" === this.method && (this.arg = t), f;
                    },
                }),
                e
            );
                                        ...
                                        function (t) {
                                            for (;;)
                                                switch ((t.prev = t.next)) {
                                                    case 0:
                                                        if (((a = { requests: (n = []) }), (i = this.requests.entries()), !(o = i.next()).done)) {
                                                            t.next = 8;
                                                            break;
                                                        }
                                                    ...
                                                    case 16:
                                                        ...
                                                        throw (
                                                            (((h = new Error("Content-type header is not mentioned for request #".concat(c.id, ", For request having body, Content-type header should be mentioned"))).name =
                                            ...
                                            switch ((r.prev = r.next)) {
                                                case 0:
                                                    if (
                                                        ((a = { url: "" }),
                                                        (o = new RegExp("^https?://")),
                                                        (a.url = o.test(t.url) ? "/" + t.url.split(/.*?\/\/.*?\//)[1] : t.url),
                                                        (a.method = t.method),
                                                        (s = {}),
                                                        t.headers.forEach(function (e, t) {
                                                            s[t] = e;
                                                        }),
                                                        Object.keys(s).length && (a.headers = s),
                                                        t.method !== i.PATCH && t.method !== i.POST && t.method !== i.PUT)
                                                    ) {
                                                        r.next = 11;
                                                        break;
                                                    }
    ...
    var h,
        ...
        f = function (e, t, r) {
            var n = null;
            if ("undefined" != typeof Request && e instanceof Request) n = e.headers.get(r);
            else if (void 0 !== t && void 0 !== t.headers)
                if ("undefined" != typeof Headers && t.headers instanceof Headers) n = t.headers.get(r);
        ...
        v = function (e, t, r, n) {
            if ("undefined" != typeof Request && e instanceof Request) e.headers.set(r, n);
            else if (void 0 !== t)
                if (void 0 === t.headers) t.headers = new Headers(l({}, r, n));
                else if ("undefined" != typeof Headers && t.headers instanceof Headers) t.headers.set(r, n);
                else if (t.headers instanceof Array) {
                            ...
                            switch ((r.prev = r.next)) {
                                ...
                                case 9:
                                    return (
                                        ...
                                        (f = t.keepalive),
                                        (v = t.signal),
                                        r.abrupt("return", new Request(e, { method: i, headers: o, body: a, referrer: s, referrerPolicy: u, mode: c, credentials: d, cache: h, redirect: l, integrity: p, keepalive: f, signal: v }))
                                    );
                                case 12:
                                case "end":
                                    return r.stop();
    ...
    ((h = e.FeatureUsageFlag || (e.FeatureUsageFlag = {}))[(h.NONE = 0)] = "NONE"),
        (h[(h.REDIRECT_HANDLER_ENABLED = 1)] = "REDIRECT_HANDLER_ENABLED"),
        (h[(h.RETRY_HANDLER_ENABLED = 2)] = "RETRY_HANDLER_ENABLED"),
        (h[(h.AUTHENTICATION_HANDLER_ENABLED = 4)] = "AUTHENTICATION_HANDLER_ENABLED");
    var x = (function () {
            function t() {
                    ...
                    [
                        {
                            ...
                            value: function (e, r) {
                                var n;
                                e.middlewareControl instanceof d ? (n = e.middlewareControl.getMiddlewareOptions(t)) : (e.middlewareControl = new d()),
                                    void 0 === n && ((n = new t()), e.middlewareControl.setMiddlewareOptions(t, n)),
                                    n.setFeatureUsage(r);
                            },
                        },
                    ]
                                            ...
                                            for (;;)
                                                switch ((r.prev = r.next)) {
                                                    case 0:
                                                        return (
                                                            (r.prev = 0),
                                                            n.middlewareControl instanceof d && (i = n.middlewareControl.getMiddlewareOptions(w)),
                                                            void 0 !== i && ((o = i.authenticationProvider), (s = i.authenticationProviderOptions)),
                                                            void 0 === o && (o = this.authenticationProvider),
                                                            (r.next = 6),
                                                            o.getAccessToken(s)
                                                        );
                                                    case 6:
                                                        return (
                                                            (u = r.sent),
                                                            (c = "Bearer ".concat(u)),
                                                            y(n.request, n.options, t.AUTHORIZATION_HEADER, c),
                                                            x.updateFeatureUsageFlag(n, e.FeatureUsageFlag.AUTHENTICATION_HANDLER_ENABLED),
                                                            (r.next = 12),
                                                            this.nextMiddleware.execute(n)
                                                        );
                                                    case 12:
    ...
    (b.DEFAULT_DELAY = 3),
        (b.DEFAULT_MAX_RETRIES = 3),
        (b.MAX_DELAY = 180),
        (b.MAX_MAX_RETRIES = 10),
        (b.DEFAULT_SHOULD_RETRY = function () {
            return !0;
        });
    var k = (function () {
        function t() {
            ...
            o(t, [
                ...
                },
                {
                    ...
                    value: function (e, r, n) {
                        ...
                        return (
                            (a = null !== o ? (Number.isNaN(Number(o)) ? Math.round((new Date(o).getTime() - Date.now()) / 1e3) : Number(o)) : r >= 2 ? this.getExponentialBackOffTime(r) + n + i() : n + i()),
                            Math.min(a, this.options.getMaxDelay() + i())
                        );
                    },
                },
                {
                                            ...
                                            for (;;)
                                                switch ((r.prev = r.next)) {
                                                    case 0:
                                                        return (
                                                            (r.prev = 0),
                                                            (a = "string" == typeof t.request ? t.request : t.request.url),
                                                            L(a)
                                                                ? ((i = f(t.request, t.options, e.CLIENT_REQUEST_ID_HEADER)) || ((i = p()), v(t.request, t.options, e.CLIENT_REQUEST_ID_HEADER, i)),
                                                                  (o = "".concat(e.PRODUCT_NAME, "/").concat("2.2.1")),
                                                                  t.middlewareControl instanceof d && (s = t.middlewareControl.getMiddlewareOptions(x)),
                                                                  s && ((u = s.getFeatureUsage()), (o += " (".concat(e.FEATURE_USAGE_STRING, "=").concat(u, ")"))),
                                                                  y(t.request, t.options, e.SDK_VERSION_HEADER, o))
                                                                : (delete t.options.headers[e.CLIENT_REQUEST_ID_HEADER], delete t.options.headers[e.SDK_VERSION_HEADER]),
                                                            (r.next = 5),
    ...
    (_.DEFAULT_MAX_REDIRECTS = 5),
        (_.MAX_MAX_REDIRECTS = 20),
        (_.DEFAULT_SHOULD_RETRY = function () {
            return !0;
        });
    var C = (function () {
        function t() {
                                    ...
                                    function (r) {
                                        for (;;)
                                            switch ((r.prev = r.next)) {
                                                ...
                                                case 11:
                                                    return (
                                                        (u = this.getLocationHeader(s)),
                                                        !this.isRelativeURL(u) && this.shouldDropAuthorizationHeader(s.url, u) && delete e.options.headers[t.AUTHORIZATION_HEADER],
                                                        (r.next = 15),
                                                        this.updateRequestUrl(u, e)
                                                    );
                                                case 15:
                                            ...
                                            switch ((r.prev = r.next)) {
                                                case 0:
                                                    return (
                                                        ...
                                                        0,
                                                        (i = this.getOptions(n)),
                                                        (n.options.redirect = t.MANUAL_REDIRECT),
                                                        x.updateFeatureUsageFlag(n, e.FeatureUsageFlag.REDIRECT_HANDLER_ENABLED),
                                                        (r.next = 7),
                                                        this.executeWithRedirect(n, 0, i)
                                                    );
                                                case 7:
                                                    return r.abrupt("return", r.sent);
                                                case 10:
    ...
    var N = function t() {
            ...
            if ((n(this, t), (this.chaosStrategy = r), (this.statusCode = i), (this.statusMessage = a), (this.chaosPercentage = void 0 !== o ? o : 10), (this.responseBody = s), this.chaosPercentage > 100))
                throw new Error("Error Pecentage can not be more than 100");
        },
        q = { GET: [429, 500, 502, 503, 504], POST: [429, 500, 502, 503, 504, 507], PUT: [429, 500, 502, 503, 504, 507], PATCH: [429, 500, 502, 503, 504], DELETE: [429, 500, 502, 503, 504, 507] },
        I = {
            100: "Continue",
                ...
                o(t, [
                    {
                        ...
                        value: function (e, t, r) {
                            ...
                            return (
                                ...
                                429 === e && n.append("retry-after", "300"),
                                n
                            );
                        },
                    },
                    {
                        ...
                        value: function (e, t, r, n, a) {
                            if (a) return a;
                            var i;
                            e >= 400 ? (i = { error: { code: I[e], message: t, innerError: { "request-id": r, date: n } } }) : (i = {});
                            return i;
                        },
                    },
                    {
                        ...
                        value: function (e, t) {
                            try {
                                ...
                                var s = { url: o, status: e.statusCode, statusText: e.statusMessage, headers: n };
                                ...
                                if (t.chaosStrategy === e.ChaosStrategy.MANUAL) {
                                    if (void 0 === t.statusCode) {
                                        ...
                                        void 0 !== this.manualMap.get(i)
                                            ? void 0 !== this.manualMap.get(i).get(n) && (t.statusCode = this.manualMap.get(i).get(n))
        ...
        j = (function () {
            function e(t, r, a) {
                ...
                n(this, e),
                    ...
                    (this.client = t),
                    (this.file = r),
                    void 0 === i.rangeSize && (i.rangeSize = this.DEFAULT_FILE_SIZE),
                    (this.options = i),
                    (this.uploadSession = a),
                    (this.nextRange = new H(0, this.options.rangeSize - 1));
            }
            return (
                o(
                    e,
                                                        ...
                                                        case 0:
                                                            return (
                                                                ...
                                                                this.client
                                                                    ...
                                                                    .headers({ "Content-Length": "".concat(t.maxValue - t.minValue + 1), "Content-Range": "bytes ".concat(t.minValue, "-").concat(t.maxValue, "/").concat(n) })
                                                                    .put(e)
                                                            );
                                                        case 3:
                                                            return r.abrupt("return", r.sent);
                                            ...
                                            function (r) {
                                                for (;;)
                                                    switch ((r.prev = r.next)) {
                                                        ...
                                                        case 3:
                                                            return (o = r.sent), (s = { url: o.uploadUrl, expiry: new Date(o.expirationDateTime) }), r.abrupt("return", s);
                                                        case 8:
                                                            throw ((r.prev = 8), (r.t0 = r.catch(0)), r.t0);
                                                        case 11:
                                                        case "end":
                                                ...
                                                for (;;)
                                                    switch ((t.prev = t.next)) {
                                                        case 0:
                                                            return (
                                                                (t.prev = 0),
                                                                (n = { name: this.file.name, "@microsoft.graph.conflictBehavior": "rename", "@microsoft.graph.sourceUrl": this.uploadSession.url }),
                                                                (t.next = 4),
                                                        ...
                                                        case 0:
                                                            return (
                                                                ...
                                                                "undefined" != typeof Blob && n instanceof Blob
                                                                    ? ((s = new File([n], o)), (u = s.size))
                                                                    : "undefined" != typeof File && n instanceof File
                                                                    ? (u = (s = n).size)
                                                                    : "undefined" != typeof Buffer && n instanceof Buffer && ((u = (c = n).byteLength - c.byteOffset), (s = c.buffer.slice(c.byteOffset, c.byteOffset + c.byteLength))),
                                                                (r.prev = 2),
                                                                (d = t.constructCreateSessionUrl(a.fileName, a.path)),
                                                                (r.next = 6),
                                                                t.createUploadSession(e, d, a.fileName)
                                                            );
                                                        case 6:
                                                            return (h = r.sent), (l = W(a.rangeSize)), (p = { name: o, content: s, size: u }), r.abrupt("return", new t(e, p, h, { rangeSize: l }));
                                                        case 12:
                                        ...
                                        return r.wrap(
                                            function (t) {
                                                for (;;)
                                                    switch ((t.prev = t.next)) {
                                                        case 0:
                                                            return (i = { item: { "@microsoft.graph.conflictBehavior": "rename", name: a } }), (t.prev = 1), t.abrupt("return", o.createUploadSession.call(this, e, n, i));
                                                        case 5:
                                                ...
                                                switch ((e.prev = e.next)) {
                                                    case 0:
                                                        return (
                                                            ...
                                                            this.requestOptions &&
                                                                (this.requestOptions.headers && (t = t.headers(this.requestOptions.headers)),
    ...
    var ie,
        ...
        de = (function (e) {
            function t() {
                ...
                return (
                    n(this, t),
                    (e = B(this, X(t).call(this, a || (i && i.message)))),
                    Object.setPrototypeOf(Q(e), t.prototype),
                    (e.statusCode = r),
                    (e.code = null),
                    (e.requestId = null),
                    (e.date = new Date()),
                    (e.body = null),
                    (e.stack = i ? i.stack : e.stack),
                    e
                );
            }
            return V(t, e), t;
                ...
                function t(r) {
                    ...
                    return (
                        (e.exports = t = function (e) {
                            ...
                            return (t.prototype = Object.create(e.prototype, { constructor: { value: t, enumerable: !1, writable: !0, configurable: !0 } })), $(t, e);
                        }),
                        t(r)
                    );
                }
    ...
    ((ie = e.ResponseType || (e.ResponseType = {})).ARRAYBUFFER = "arraybuffer"),
        (ie.BLOB = "blob"),
        (ie.DOCUMENT = "document"),
        (ie.JSON = "json"),
        (ie.RAW = "raw"),
        (ie.STREAM = "stream"),
        (ie.TEXT = "text"),
    ...
    var le = (function () {
                                                ...
                                                switch ((r.prev = r.next)) {
                                                    ...
                                                    case 2:
                                                        (r.prev = 2),
                                                            (r.t0 = a),
                                                            (r.next =
                                                                r.t0 === e.ResponseType.ARRAYBUFFER
                                                                    ? 6
                                                                    : r.t0 === e.ResponseType.BLOB
                                                                    ? 10
                                                                    : r.t0 === e.ResponseType.DOCUMENT
                                                                    ? 14
                                                                    : r.t0 === e.ResponseType.JSON
                                                                    ? 18
                                                                    : r.t0 === e.ResponseType.STREAM
                                                                    ? 22
                                                                    : r.t0 === e.ResponseType.TEXT
                                                                    ? 26
                                                                    : 30);
                                                        break;
                                                    case 6:
        ...
        pe = (function () {
            function t(e, r, a) {
                ...
                n(this, t),
                    ...
                    (this.httpClient = e),
                    (this.config = r),
                    (this.urlComponents = { host: this.config.baseUrl, version: this.config.defaultVersion, oDataQueryParams: {}, otherURLQueryParams: {}, otherURLQueryOptions: [] }),
                    (this._headers = {}),
                    (this._options = {}),
                ...
                o(t, [
                    ...
                    },
                    {
                        ...
                        value: function () {
                            var e,
                                t,
                                r =
                                    ((e = [this.urlComponents.host, this.urlComponents.version, this.urlComponents.path]),
                                    (t = function (e) {
                                        return e.replace(/^\/+/, "");
                                    }),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            var e = this.urlComponents,
                                t = [];
                            if (0 !== Object.keys(e.oDataQueryParams).length) for (var r in e.oDataQueryParams) e.oDataQueryParams.hasOwnProperty(r) && t.push(r + "=" + e.oDataQueryParams[r]);
                            if (0 !== Object.keys(e.otherURLQueryParams).length) for (var n in e.otherURLQueryParams) e.otherURLQueryParams.hasOwnProperty(n) && t.push(n + "=" + e.otherURLQueryParams[n]);
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            else if (e.constructor === Object) for (var u in e) e.hasOwnProperty(u) && this.setURLComponentsQueryParamater(u, e[u]);
                            return this;
                        },
                    },
                    {
                                    ...
                                    return r.wrap(
                                        function (r) {
                                            for (;;)
                                                switch ((r.prev = r.next)) {
                                                    case 0:
                                                        return (o = new d(this._middlewareOptions)), this.updateRequestOptions(t), (r.prev = 2), (r.next = 5), this.httpClient.sendRequest({ request: e, options: t, middlewareControl: o });
                                                    case 5:
                                    ...
                                    return r.wrap(
                                        function (t) {
                                            for (;;)
                                                switch ((t.prev = t.next)) {
                                                    case 0:
                                                        return (n = this.buildFullUrl()), (a = { method: i.GET }), (t.prev = 2), (t.next = 5), this.send(n, a, e);
                                                    case 5:
                                            ...
                                            for (;;)
                                                switch ((r.prev = r.next)) {
                                                    case 0:
                                                        return (
                                                            (a = this.buildFullUrl()),
                                                            (o = { method: i.POST, body: D(e) }),
                                                            "FormData" === (e && e.constructor && e.constructor.name) ? (o.headers = {}) : (this.setHeaderContentType(), (o.headers = this._headers)),
                                                            (r.prev = 4),
                                                            (r.next = 7),
                                                            this.send(a, o, t)
                                                        );
                                    ...
                                    return r.wrap(
                                        function (r) {
                                            for (;;)
                                                switch ((r.prev = r.next)) {
                                                    case 0:
                                                        return (a = this.buildFullUrl()), this.setHeaderContentType(), (o = { method: i.PUT, body: D(e) }), (r.prev = 3), (r.next = 6), this.send(a, o, t);
                                                    case 6:
                                                        return (s = r.sent), r.abrupt("return", s);
                                                    case 10:
                                    ...
                                    return r.wrap(
                                        function (r) {
                                            for (;;)
                                                switch ((r.prev = r.next)) {
                                                    case 0:
                                                        return (a = this.buildFullUrl()), this.setHeaderContentType(), (o = { method: i.PATCH, body: D(e) }), (r.prev = 3), (r.next = 6), this.send(a, o, t);
                                                    case 6:
                                                        return (s = r.sent), r.abrupt("return", s);
                                                    case 10:
                                                        throw ((r.prev = 10), (r.t0 = r.catch(3)), r.t0);
                                    ...
                                    return r.wrap(
                                        function (t) {
                                            for (;;)
                                                switch ((t.prev = t.next)) {
                                                    case 0:
                                                        return (n = this.buildFullUrl()), (a = { method: i.DELETE }), (t.prev = 2), (t.next = 5), this.send(n, a, e);
                                                    case 5:
                                                        return (o = t.sent), t.abrupt("return", o);
                                                    case 9:
                                                        throw ((t.prev = 9), (t.t0 = t.catch(2)), t.t0);
                                    ...
                                    return r.wrap(
                                        function (r) {
                                            for (;;)
                                                switch ((r.prev = r.next)) {
                                                    case 0:
                                                        return (a = this.buildFullUrl()), (o = { method: i.GET }), this.responseType(e.ResponseType.STREAM), (r.prev = 3), (r.next = 6), this.send(a, o, t);
                                                    case 6:
                                                        return (s = r.sent), r.abrupt("return", s);
                                                    case 10:
                                                        throw ((r.prev = 10), (r.t0 = r.catch(3)), r.t0);
                                    ...
                                    return r.wrap(
                                        function (r) {
                                            for (;;)
                                                switch ((r.prev = r.next)) {
                                                    case 0:
                                                        return (a = this.buildFullUrl()), (o = { method: i.PUT, headers: { "Content-Type": "application/octet-stream" }, body: e }), (r.prev = 2), (r.next = 5), this.send(a, o, t);
                                                    case 5:
                                                        return (s = r.sent), r.abrupt("return", s);
                                                    case 9:
        ...
        me = (function () {
            function e(t) {
                n(this, e), (this.config = { baseUrl: O, debugLogging: !1, defaultVersion: R });
                try {
                    ye();
                } catch (i) {
                    throw i;
                }
                for (var r in t) t.hasOwnProperty(r) && (this.config[r] = t[r]);
                var a;
                ...
                if (void 0 !== t.authProvider) a = ve.createWithAuthenticationProvider(t.authProvider);
                else {
                    ...
                    [
                        {
                            ...
                            value: function (t) {
                                var r = {};
                                for (var n in t) t.hasOwnProperty(n) && (r[n] = "authProvider" === n ? new ae(t[n]) : t[n]);
                                            ...
                                            for (;;)
                                                switch ((t.prev = t.next)) {
                                                    ...
                                                    case 8:
                                                        ...
                                                        return (o = { scopes: a }), (t.prev = 10), (t.next = 13), this.msalApplication.acquireTokenSilent(o);
                                                    case 13:
                                                    ...
                                                    case 33:
                                                        ...
                                                        break;
                                                    case 35:
                                                        return (t.prev = 35), (c = { scopes: a }), (t.next = 39), this.msalApplication.loginPopup(c);
                                                    case 39:
    ...
    return (
        (e.AuthenticationHandler = g),
        (e.AuthenticationHandlerOptions = w),
        (e.BatchRequestContent = u),
        (e.BatchResponseContent = c),
        (e.ChaosHandler = F),
        (e.ChaosHandlerOptions = N),
        (e.Client = me),
        (e.CustomAuthenticationProvider = ae),
        (e.GraphError = de),
        (e.GraphRequest = pe),
        (e.HTTPMessageHandler = E),
        (e.ImplicitMSALAuthenticationProvider = we),
        (e.LargeFileUploadTask = j),
        (e.MSALAuthenticationProviderOptions = function e(t) {
            n(this, e), (this.scopes = t);
        }),
        (e.MiddlewareFactory = U),
        (e.OneDriveLargeFileUploadTask = J),
        (e.PageIterator = Z),
        (e.RetryHandler = k),
        (e.RetryHandlerOptions = b),
        (e.TelemetryHandler = P),
        (e.TelemetryHandlerOptions = x),
        e
    );
})({});
