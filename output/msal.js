...
!function (e, t) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? t(exports) : "function" == typeof define && define.amd ? define(["exports"], t) : t((e = e || self).msal = {});
}(void 0, function (o) {
  ...
  var a,
    ...
    unexpectedError: {
      ...
      c = (t(s, a = Error), s.createUnexpectedError = function (e) {
  ...
  var u,
    ...
    desc: "Client credential (secret, certificate, or assertion) must not be empty when creating a confidential client. An application should at most have one credential"
      ...
      $ = (t(ee, u = c), ee.createClientInfoDecodingError = function (e) {
  ...
  var oe = (ie.prototype.logMessage = function (e, t) {
  ...
  (Le = Ue = Ue || {}).ACCOUNT = "account", Le.SID = "sid", Le.LOGIN_HINT = "login_hint", Le.ID_TOKEN = "id_token", Le.DOMAIN_HINT = "domain_hint", Le.ORGANIZATIONS = "organizations", Le.CONSUMERS = "consumers", Le.ACCOUNT_ID = "accountIdentifier", Le.HOMEACCOUNT_ID = "homeAccountIdentifier";
  ...
  var Xe = {
    ...
    VALUE_SEPARATOR: ","
      ...
      Ze = ($e.prototype.generateAccountId = function () {
  ...
  var et,
    ...
    desc: "The provided authority is not a trusted authority. Please include this authority in the knownAuthorities config parameter."
      ...
      vt = (t(Ct, et = $), Ct.createRedirectUriEmptyError = function () {
  ...
  var wt = (Tt.fromString = function (e) {
  ...
  function Tt(e) {
    var t = this,
        r = e ? re.trimArrayEntries(function () {
    ...
    this.validateInputScopes(n), this.scopes = new Set(), n.forEach(function (e) {
  ...
  var St = (Object.defineProperty(At.prototype, "urlString", {
    get: function get() {
    ...
    var t = new RegExp("(\\&" + e + "=)[^&]+");
    return this._urlString = this.urlString.replace(t, ""), t = new RegExp("(" + e + "=)[^&]+&"), this._urlString = this.urlString.replace(t, ""), t = new RegExp("(" + e + "=)[^&]+"), this._urlString = this.urlString.replace(t, ""), this.urlString;
  ...
  var Rt = (_t.setTrustedAuthoritiesFromConfig = function (e, t) {
  ...
  }, _t.TrustedHostList = {}, _t);

  function _t() {}

  var bt = (Ot.prototype.generateAccountId = function () {
    ...
    return Ot.generateAccountCacheKey({
  ...
  var Nt = (kt.prototype.getAllAccounts = function () {
    ...
    return e.forEach(function (e) {
      ...
      if (r !== Pe) {
        ...
        if ((re.isEmpty(n) || u.matchHomeAccountId(t, n)) && (re.isEmpty(o) || u.matchEnvironment(t, o)) && (re.isEmpty(c) || u.matchRealm(t, c)) && (re.isEmpty(i) || u.matchCredentialType(t, i)) && (re.isEmpty(a) || u.matchClientId(t, a)) && (re.isEmpty(s) || u.matchTarget(t, s))) switch (r) {
          case ze.ID_TOKEN:
            d.idTokens[e] = t;
            break;
  ...
  var Pt,
      Ut = (t(Lt, Pt = Nt), Lt.prototype.setItem = function () {
  ...
  var jt = (Gt.prototype.createDefaultTokenRequestHeaders = function () {
    var e = this.createDefaultLibraryHeaders();
    return e[ae.CONTENT_TYPE] = Ne, this.serverTelemetryManager && (e[ae.X_CLIENT_CURR_TELEM] = this.serverTelemetryManager.generateCurrentRequestHeaderValue(), e[ae.X_CLIENT_LAST_TELEM] = this.serverTelemetryManager.generateLastRequestHeaderValue()), e;
    ...
    return h(this, void 0, void 0, function () {
      ...
      return m(this, function (e) {
        switch (e.label) {
          case 0:
            return [4, this.networkClient.sendPostRequestAsync(r, {
              body: n,
              headers: o
            })];
  ...
  var Wt = (Bt.prototype.addResponseTypeCode = function () {
    ...
    var r = this;
    zt.sanitizeEQParams(t, this.parameters), Object.keys(t).forEach(function (e) {
      r.parameters.set(e, t[e]);
    });
  }, Bt.prototype.addClientCapabilitiesToClaims = function (e, t) {
    var r;
    if (re.isEmpty(e)) r = {};else try {
      r = JSON.parse(e);
    } catch (e) {
      throw vt.createInvalidClaimsRequestError();
    }
    return t && 0 < t.length && (r.hasOwnProperty(me.ACCESS_TOKEN) || (r[me.ACCESS_TOKEN] = {}), r[me.ACCESS_TOKEN][me.XMS_CC] = {
      values: t
    }), JSON.stringify(r);
  ...
  var Xt = (Zt.extractIdToken = function (e, t) {
  ...
  var nr,
      or = (t(ir, nr = Ze), ir.createIdTokenEntity = function (e, t, r, n, o) {
    var i = new ir();
    ...
    return e.hasOwnProperty("homeAccountId") && e.hasOwnProperty("environment") && e.hasOwnProperty("credentialType") && e.hasOwnProperty("realm") && e.hasOwnProperty("clientId") && e.hasOwnProperty("secret") && e.credentialType === ze.ID_TOKEN;
  }, ir);
  ...
  var ar,
      cr = (t(sr, ar = Ze), sr.createAccessTokenEntity = function (e, t, r, n, o, i, a, c) {
    var s = new sr();
    ...
    return e.hasOwnProperty("homeAccountId") && e.hasOwnProperty("environment") && e.hasOwnProperty("credentialType") && e.hasOwnProperty("realm") && e.hasOwnProperty("clientId") && e.hasOwnProperty("secret") && e.hasOwnProperty("target") && e.credentialType === ze.ACCESS_TOKEN;
  }, sr);
  ...
  var ur,
      dr = (t(hr, ur = Ze), hr.createRefreshTokenEntity = function (e, t, r, n, o) {
    var i = new hr();
  ...
  var lr,
      ...
      yr = (t(mr, lr = Qt), mr.isInteractionRequiredError = function (e, t, r) {
    var n = !re.isEmpty(e) && -1 < pr.indexOf(e),
        o = !re.isEmpty(r) && -1 < fr.indexOf(r),
        i = !re.isEmpty(t) && pr.some(function (e) {
  ...
  var gr = function gr(e, t, r, n) {
    this.account = e, this.idToken = t, this.accessToken = r, this.refreshToken = n;
      ...
      Er = (vr.setRequestState = function (e, t, r) {
    ...
    try {
      var r = decodeURIComponent(t).split(Se),
          ...
          a = JSON.parse(i);
      return {
        userRequestState: re.isEmpty(o) ? "" : o,
        libraryState: a
      };
    } catch (e) {
  ...
  var Cr = (wr.prototype.validateServerAuthorizationCodeResponse = function (e, t, r) {
    ...
    e.client_info ? (this.clientInfo = It(e.client_info, this.cryptoObj), re.isEmpty(this.clientInfo.uid) || re.isEmpty(this.clientInfo.utid) || (this.homeAccountIdentifier = this.clientInfo.uid + "." + this.clientInfo.utid)) : this.homeAccountIdentifier = "";
    var i = null;
    ...
    var o = "",
        ...
        c = null,
        s = null;
    return e.accessToken && (o = e.accessToken.secret, i = wt.fromString(e.accessToken.target).asArray(), a = new Date(1e3 * Number(e.accessToken.expiresOn)), c = new Date(1e3 * Number(e.accessToken.extendedExpiresOn))), e.refreshToken && (s = e.refreshToken.familyId || null), {
  ...
  var Tr,
      Ir = (t(Sr, Tr = jt), Sr.prototype.getAuthCodeUrl = function (r) {
    return h(this, void 0, void 0, function () {
      var t;
      return m(this, function (e) {
    ...
    return h(this, void 0, void 0, function () {
      ...
      return m(this, function (e) {
        switch (e.label) {
          ...
          case 1:
            return t = e.sent(), (r = new Cr(this.config.authOptions.clientId, this.cacheManager, this.cryptoUtils, this.logger)).validateTokenResponse(t.body), [2, r.handleServerTokenResponse(t.body, this.authority, o, i)];
        }
      });
    });
    ...
    if (t.addScopes(r), t.addAuthorizationCode(e.code), e.codeVerifier && t.addCodeVerifier(e.codeVerifier), this.config.clientCredentials.clientSecret && t.addClientSecret(this.config.clientCredentials.clientSecret), this.config.clientCredentials.clientAssertion) {
    ...
    return t.addCorrelationId(o), (!re.isEmpty(e.claims) || this.config.authOptions.clientCapabilities && 0 < this.config.authOptions.clientCapabilities.length) && t.addClaims(e.claims, this.config.authOptions.clientCapabilities), t.createQueryString();
  ...
  var Ar;
  t(Rr, Ar = jt), Rr.prototype.acquireToken = function (o) {
    return h(this, void 0, void 0, function () {
      var t, r, n;
      return m(this, function (e) {
        switch (e.label) {
    ...
    return h(this, void 0, void 0, function () {
      ...
      return m(this, function (e) {
        switch (e.label) {
          case 0:
            return [4, this.networkClient.sendPostRequestAsync(s, {
              body: u,
              headers: d
            })];

          case 1:
            return t = e.sent().body, r = t.user_code, n = t.device_code, o = t.verification_uri, i = t.expires_in, a = t.interval, c = t.message, [2, {
              userCode: r,
              deviceCode: n,
              verificationUri: o,
              expiresIn: i,
    ...
    var t = new Wt(),
        r = new wt(e.scopes || []);
    return t.addScopes(r), t.addClientId(this.config.authOptions.clientId), (!re.isEmpty(e.claims) || this.config.authOptions.clientCapabilities && 0 < this.config.authOptions.clientCapabilities.length) && t.addClaims(e.claims, this.config.authOptions.clientCapabilities), t.createQueryString();
    ...
    return h(this, void 0, void 0, function () {
      var a,
          ...
          r = this;
      return m(this, function (e) {
        return a = this.createTokenRequestBody(u, n), c = this.createDefaultTokenRequestHeaders(), s = tr.nowSeconds() + n.expiresIn, t = 1e3 * n.interval, [2, new Promise(function (n, o) {
          var i = setInterval(function () {
            return h(r, void 0, void 0, function () {
              ...
              return m(this, function (e) {
                switch (e.label) {
                  case 0:
                    return e.trys.push([0, 5,, 6]), u.cancel ? (this.logger.error("Token request cancelled by setting DeviceCodeRequest.cancel = true"), clearInterval(i), o($.createDeviceCodeCancelledError()), [3, 4]) : [3, 1];
    ...
    var o = e.correlationId || this.config.cryptoInterface.createNewGuid();
    return r.addCorrelationId(o), r.addClientInfo(), (!re.isEmpty(e.claims) || this.config.authOptions.clientCapabilities && 0 < this.config.authOptions.clientCapabilities.length) && r.addClaims(e.claims, this.config.authOptions.clientCapabilities), r.createQueryString();
  };
  ...
  var _r,
      br = (t(Or, _r = jt), Or.prototype.acquireToken = function (n) {
    return h(this, void 0, void 0, function () {
      var t, r;
      return m(this, function (e) {
        switch (e.label) {
  ...
  var Nr;
  t(kr, Nr = jt), kr.prototype.acquireToken = function (r) {
    return h(this, void 0, void 0, function () {
      var t;
      return m(this, function (e) {
        switch (e.label) {
    ...
    return !e || tr.isTokenExpired(e.expiresOn, this.config.systemOptions.tokenRenewalOffsetSeconds) ? null : Cr.generateAuthenticationResult({
      account: null,
      accessToken: e,
      idToken: null,
      refreshToken: null
    ...
    return h(this, void 0, void 0, function () {
      ...
      return m(this, function (e) {
        switch (e.label) {
          ...
          case 1:
            return n = e.sent(), (o = new Cr(this.config.authOptions.clientId, this.cacheManager, this.cryptoUtils, this.logger)).validateTokenResponse(n.body), [2, o.handleServerTokenResponse(n.body, this.authority, null, null, i.scopes)];
        }
      });
    });
  ...
  var Pr,
      Ur = (t(Lr, Pr = jt), Lr.prototype.acquireToken = function (l) {
    return h(this, void 0, void 0, function () {
      ...
      return m(this, function (e) {
        ...
        if (t = new wt(l.scopes || []), r = bt.generateAccountCacheKey(l.account), n = this.cacheManager.getAccount(r), o = n.homeAccountId, i = n.environment, a = this.readAccessTokenFromCache(o, i, t, n.realm), c = this.readRefreshTokenFromCache(o, i), this.isRefreshRequired(l, a)) {
          if (!c) throw $.createNoTokensFoundError();
          return s = new br(this.config), u = _p(_p({}, l), {
            refreshToken: c.secret
          }), [2, s.acquireToken(u)];
        }

        return this.config.serverTelemetryManager && this.config.serverTelemetryManager.incrementCacheHits(), d = this.readIdTokenFromCache(o, i, n.realm), h = new Xt(d.secret, this.config.cryptoInterface), [2, Cr.generateAuthenticationResult({
          account: n,
          accessToken: a,
          idToken: d,
          refreshToken: c
  ...
  var Dr = (Object.defineProperty(Mr.prototype, "authorityType", {
    get: function get() {
  ...
  var qr = (Hr.createDiscoveredInstance = function (n, o) {
    return h(this, void 0, void 0, function () {
      var t, r;
      return m(this, function (e) {
        switch (e.label) {
  ...
  var xr = (Kr.prototype.generateCurrentRequestHeaderValue = function () {
    ...
    t.failedRequests.push(this.apiId, this.correlationId), t.errors.push(e.errorCode), t.errorCount += 1, t.errors.length > Xe.FAILURE_LIMIT && (t.failedRequests.shift(), t.failedRequests.shift(), t.errors.shift()), this.cacheManager.setItem(this.telemetryCacheKey, t, We.TELEMETRY);
    ...
    return this.cacheManager.getItem(this.telemetryCacheKey, We.TELEMETRY) || {
      failedRequests: [],
      errors: [],
      errorCount: 0,
      cacheHits: 0
  ...
  var Fr,
      ...
      rn = 50,
      nn = "msal.js.browser";
  (jr = Fr = Fr || {}).GET = "GET", jr.POST = "POST", (zr = Gr = Gr || {}).AUTHORITY = "authority", zr.ACQUIRE_TOKEN_ACCOUNT = "acquireToken.account", zr.SESSION_STATE = "session.state", zr.REQUEST_STATE = "request.state", zr.NONCE_IDTOKEN = "nonce.id_token", zr.ORIGIN_URI = "request.origin", zr.RENEW_STATUS = "token.renew.status", zr.URL_HASH = "urlHash", zr.REQUEST_PARAMS = "request.params", zr.SCOPES = "scopes", (Wr = Yr = Yr || {})[Wr.acquireTokenRedirect = 861] = "acquireTokenRedirect", Wr[Wr.acquireTokenPopup = 862] = "acquireTokenPopup", Wr[Wr.ssoSilent = 863] = "ssoSilent", Wr[Wr.acquireTokenSilent_authCode = 864] = "acquireTokenSilent_authCode", Wr[Wr.handleRedirectPromise = 865] = "handleRedirectPromise", Wr[Wr.acquireTokenSilent_silentFlow = 61] = "acquireTokenSilent_silentFlow", (Vr = Br = Br || {}).REDIRECT = "redirect", Vr.POPUP = "popup", Vr.SILENT = "silent";
  var on = {
    scopes: [Ae, Re]
  },
      an = (cn.prototype.sendGetRequestAsync = function (n, o) {
    ...
    return l(this, void 0, void 0, function () {
      ...
      return y(this, function (e) {
        switch (e.label) {
          case 0:
            return t = i && i.body || "", [4, fetch(o, {
              method: Fr.POST,
              headers: this.getFetchHeaders(i),
              body: t
            })];
    ...
    var r = new Headers();
    return t && t.headers && Object.keys(t.headers).forEach(function (e) {
  ...
  var sn,
    ...
    invalidCacheType: {
      ...
      dn = (e(hn, sn = c), hn.createNoWindowObjectError = function () {
  ...
  var ln = (pn.prototype.sendGetRequestAsync = function (t, r) {
    return l(this, void 0, void 0, function () {
      return y(this, function (e) {
    ...
    return new Promise(function (r, n) {
      ...
      if (o.open(t, e, !0), a.setXhrHeaders(o, i), o.onload = function () {
        (o.status < 200 || 300 <= o.status) && n(o.responseText);

        try {
          var e = JSON.parse(o.responseText),
              t = {
            headers: a.getHeaderDict(o),
            body: e,
            status: o.status
          };
          r(t);
  ...
  var fn = (yn.navigateWindow = function (e, t) {
  ...
  var vn,
    ...
    invalidCallbackObject: {
      ...
      wn = (e(Tn, vn = c), Tn.createRedirectUriEmptyError = function () {
  ...
  var In,
      Sn = (e(An, In = Nt), An.prototype.validateWindowStorage = function (e) {
    ...
    for (e in this.removeAllAccounts(), this.removeAppMetadata(), this.windowStorage) {
      !this.windowStorage.hasOwnProperty(e) || -1 === e.indexOf(Ce) && -1 === e.indexOf(this.clientId) || this.removeItem(e);
    }
  ...
  }, An.prototype.setCache = function () {}, An.prototype.generateCacheKey = function (t) {
    try {
    ...
    }), this.removeItem(this.generateCacheKey(Gr.REQUEST_STATE)), this.removeItem(this.generateCacheKey(Gr.REQUEST_PARAMS)), this.removeItem(this.generateCacheKey(Gr.ORIGIN_URI)), this.removeItem(this.generateCacheKey(Gr.URL_HASH));
  ...
  var Rn = (_n.decimalToHex = function (e) {
  ...
  var bn = (On.prototype.generateGuid = function () {
    try {
      var e = new Uint8Array(16);
      return this.cryptoObj.getRandomValues(e), e[6] |= 64, e[6] &= 79, e[8] |= 128, e[8] &= 191, Rn.decimalToHex(e[0]) + Rn.decimalToHex(e[1]) + Rn.decimalToHex(e[2]) + Rn.decimalToHex(e[3]) + "-" + Rn.decimalToHex(e[4]) + Rn.decimalToHex(e[5]) + "-" + Rn.decimalToHex(e[6]) + Rn.decimalToHex(e[7]) + "-" + Rn.decimalToHex(e[8]) + Rn.decimalToHex(e[9]) + "-" + Rn.decimalToHex(e[10]) + Rn.decimalToHex(e[11]) + Rn.decimalToHex(e[12]) + Rn.decimalToHex(e[13]) + Rn.decimalToHex(e[14]) + Rn.decimalToHex(e[15]);
    } catch (e) {
  ...
  var Nn = (kn.stringToUtf8Arr = function (e) {
    ...
    for (var i = new Uint8Array(r), a = 0, c = 0; a < r; c++) {
      (t = e.charCodeAt(c)) < 128 ? i[a++] = t : (t < 2048 ? i[a++] = 192 + (t >>> 6) : (t < 65536 ? i[a++] = 224 + (t >>> 12) : (t < 2097152 ? i[a++] = 240 + (t >>> 18) : (t < 67108864 ? i[a++] = 248 + (t >>> 24) : (i[a++] = 252 + (t >>> 30), i[a++] = 128 + (t >>> 24 & 63)), i[a++] = 128 + (t >>> 18 & 63)), i[a++] = 128 + (t >>> 12 & 63)), i[a++] = 128 + (t >>> 6 & 63)), i[a++] = 128 + (63 & t));
    }

    return i;
  }, kn.utf8ArrToString = function (e) {
    for (var t = "", r = void 0, n = e.length, o = 0; o < n; o++) {
      r = e[o], t += String.fromCharCode(251 < r && r < 254 && o + 5 < n ? 1073741824 * (r - 252) + (e[++o] - 128 << 24) + (e[++o] - 128 << 18) + (e[++o] - 128 << 12) + (e[++o] - 128 << 6) + e[++o] - 128 : 247 < r && r < 252 && o + 4 < n ? (r - 248 << 24) + (e[++o] - 128 << 18) + (e[++o] - 128 << 12) + (e[++o] - 128 << 6) + e[++o] - 128 : 239 < r && r < 248 && o + 3 < n ? (r - 240 << 18) + (e[++o] - 128 << 12) + (e[++o] - 128 << 6) + e[++o] - 128 : 223 < r && r < 240 && o + 2 < n ? (r - 224 << 12) + (e[++o] - 128 << 6) + e[++o] - 128 : 191 < r && r < 224 && o + 1 < n ? (r - 192 << 6) + e[++o] - 128 : r);
    }
  ...
  var Pn = (Un.prototype.urlEncode = function (e) {
    ...
    for (var t = (3 - e.length % 3) % 3, r = "", n = void 0, o = e.length, i = 0, a = 0; a < o; a++) {
      n = a % 3, i |= e[a] << (16 >>> n & 24), 2 !== n && e.length - a != 1 || (r += String.fromCharCode(this.uint6ToB64(i >>> 18 & 63), this.uint6ToB64(i >>> 12 & 63), this.uint6ToB64(i >>> 6 & 63), this.uint6ToB64(63 & i)), i = 0);
    }
  ...
  var Ln = (Dn.prototype.decode = function (e) {
  ...
  var Mn = (qn.prototype.generateCodes = function () {
    return l(this, void 0, void 0, function () {
      var t, r;
      return y(this, function (e) {
        switch (e.label) {
  ...
  var Hn = "SHA-256",
      xn = (Kn.prototype.sha256Digest = function (r) {
    return l(this, void 0, void 0, function () {
      var t;
      return y(this, function (e) {
  ...
  var Fn = (jn.prototype.createNewGuid = function () {
  ...
  var Gn = (zn.prototype.handleCodeResponse = function (a) {
    return l(this, void 0, void 0, function () {
      var t, r, n, o, i;
      return y(this, function (e) {
        switch (e.label) {
          case 0:
            ...
            return t = this.browserStorage.getItem(this.browserStorage.generateCacheKey(Gr.REQUEST_STATE), We.TEMPORARY), r = this.authModule.handleFragmentResponse(a, t), n = this.browserStorage.generateNonceKey(t), o = this.browserStorage.getItem(this.browserStorage.generateCacheKey(n), We.TEMPORARY), this.authCodeRequest.code = r, [4, this.authModule.acquireToken(this.authCodeRequest, o, t)];
  ...
  var Yn,
      Wn = (e(Bn, Yn = Gn), Bn.prototype.initiateAuthRequest = function (e, t, r, n) {
    if (re.isEmpty(e)) throw this.authModule.logger.info("Navigate url is empty"), dn.createEmptyNavigationUriError();
    r && this.browserStorage.setItem(this.browserStorage.generateCacheKey(Gr.ORIGIN_URI), r, We.TEMPORARY), this.browserStorage.setItem(this.browserStorage.generateCacheKey(Xr), Zr, We.TEMPORARY), this.browserStorage.cacheCodeRequest(t, n), this.authModule.logger.infoPii("Navigate to:" + e);
    var o = fn.isInIframe();
    ...
    return l(this, void 0, void 0, function () {
      ...
      return y(this, function (e) {
        switch (e.label) {
          case 0:
            if (re.isEmpty(a)) throw dn.createEmptyHashError(a);
            return this.browserStorage.removeItem(this.browserStorage.generateCacheKey(Xr)), t = this.browserStorage.getItem(this.browserStorage.generateCacheKey(Gr.REQUEST_STATE), We.TEMPORARY), r = this.authModule.handleFragmentResponse(a, t), n = this.browserStorage.generateNonceKey(t), o = this.browserStorage.getItem(this.browserStorage.generateCacheKey(n), We.TEMPORARY), this.authCodeRequest = this.browserStorage.getCachedRequest(t, c), this.authCodeRequest.code = r, [4, this.authModule.acquireToken(this.authCodeRequest, o, t)];
  ...
  var Vn,
      Qn = (e(Jn, Vn = Gn), Jn.prototype.initiateAuthRequest = function (e, t, r) {
  ...
  var Xn,
      Zn = (e($n, Xn = Gn), $n.prototype.initiateAuthRequest = function (n, o, i) {
    return l(this, void 0, void 0, function () {
      var t, r;
      return y(this, function (e) {
        switch (e.label) {
    ...
    if (!t) {
      if (document.createElement && document.documentElement && -1 === window.navigator.userAgent.indexOf("MSIE 5.0")) {
        ...
        r.setAttribute("id", e), r.style.visibility = "hidden", r.style.position = "absolute", r.style.width = r.style.height = "0", r.style.border = "0", r.setAttribute("sandbox", "allow-scripts allow-same-origin allow-forms"), t = document.getElementsByTagName("body")[0].appendChild(r);
  ...
  var eo = (to.extractBrowserRequestState = function (e, t) {
  ...
  var ro = (no.prototype.handleRedirectPromise = function () {
    return l(this, void 0, void 0, function () {
      return y(this, function (e) {
    ...
    return l(this, void 0, void 0, function () {
      var t, r, n, o, i, a;
      return y(this, function (e) {
        return t = this.getRedirectResponseHash(), re.isEmpty(t) ? [2, null] : (r = this.browserStorage.getItem(this.browserStorage.generateCacheKey(Gr.ORIGIN_URI), We.TEMPORARY), n = St.removeHashFromUrl(r || ""), o = St.removeHashFromUrl(window.location.href), n === o && this.config.auth.navigateToLoginRequestUrl ? (-1 < r.indexOf("#") && fn.replaceHash(r), [2, this.handleHash(t)]) : this.config.auth.navigateToLoginRequestUrl ? (fn.isInIframe() || (i = this.browserStorage.generateCacheKey(Gr.URL_HASH), this.browserStorage.setItem(i, t, We.TEMPORARY), r && "null" !== r ? fn.navigateWindow(r, !0) : (a = fn.getHomepage(), this.browserStorage.setItem(this.browserStorage.generateCacheKey(Gr.ORIGIN_URI), a, We.TEMPORARY), this.logger.warning("Unable to get valid login request url from cache, redirecting to home page"), fn.navigateWindow(a, !0))), [2, null]) : [2, this.handleHash(t)]);
      });
    });
    ...
    return l(this, void 0, void 0, function () {
      ...
      return y(this, function (e) {
        switch (e.label) {
          case 0:
            t = this.browserStorage.getItem(this.browserStorage.generateCacheKey(Gr.REQUEST_PARAMS), We.TEMPORARY), r = JSON.parse(this.browserCrypto.base64Decode(t)), n = this.initializeServerTelemetryManager(Yr.handleRedirectPromise, r.correlationId), e.label = 1;
      ...
      return y(this, function (e) {
        switch (e.label) {
          case 0:
            ...
            t = this.initializeAuthorizationRequest(_f(_f({}, s), {
              prompt: De.NONE
            }), Br.SILENT), r = this.initializeServerTelemetryManager(Yr.ssoSilent, t.correlationId), e.label = 1;
    ...
    return l(this, void 0, void 0, function () {
      ...
      return y(this, function (e) {
        switch (e.label) {
          case 0:
            fn.blockReloadInHiddenIframes(), t = _f(_f({}, p), this.initializeBaseRequest(p)), r = this.initializeServerTelemetryManager(Yr.acquireTokenSilent_silentFlow, t.correlationId), e.label = 1;
          ...
          case 4:
            ...
            c = this.initializeAuthorizationRequest(_f(_f({}, t), {
              redirectUri: p.redirectUri,
              prompt: De.NONE
            }), Br.SILENT), r = this.initializeServerTelemetryManager(Yr.acquireTokenSilent_authCode, c.correlationId), e.label = 5;
    ...
    return !re.isEmpty(t) && e && e.length && e.filter(function (e) {
    ...
    return r.state = Er.setRequestState(this.browserCrypto, e && e.state || "", i), re.isEmpty(r.nonce) && (r.nonce = this.browserCrypto.createNewGuid()), r.responseMode = Me.FRAGMENT, r = _f(_f({}, r), this.initializeBaseRequest(r)), this.browserStorage.updateCacheEntries(r.state, r.nonce, r.authority), _f(_f({}, r), this.setDefaultScopes(r));
    ...
    return l(this, void 0, void 0, function () {
      ...
      return y(this, function (e) {
        switch (e.label) {
          ...
          case 1:
            return t = e.sent(), r = _f(_f({}, n), {
              redirectUri: n.redirectUri,
              code: "",
              codeVerifier: t.verifier
            }), n.codeChallenge = t.challenge, n.codeChallengeMethod = Oe, [2, r];
        }
      });
    });
    ...
    return re.isEmpty(t.authority) && (t.authority = this.config.auth.authority), t.correlationId = t && t.correlationId || this.browserCrypto.createNewGuid(), t.postLogoutRedirectUri = this.getPostLogoutRedirectUri(e ? e.postLogoutRedirectUri : ""), t;
  }, no);
  ...
  function no(e) {
    ...
    }(e), this.browserCrypto = new Fn(), this.networkClient = this.config.system.networkClient, this.browserStorage = new Sn(this.config.auth.clientId, this.config.cache), this.logger = new oe(this.config.system.loggerOptions), Rt.setTrustedAuthoritiesFromConfig(this.config.auth.knownAuthorities, this.config.auth.cloudDiscoveryMetadata), this.defaultAuthority = null;
  }

  o.AuthError = c, o.AuthErrorMessage = r, o.BrowserAuthError = dn, o.BrowserAuthErrorMessage = un, o.BrowserConfigurationAuthError = wn, o.BrowserConfigurationAuthErrorMessage = Cn, o.InteractionRequiredAuthError = yr, o.Logger = oe, o.PublicClientApplication = ro, Object.defineProperty(o, "__esModule", {
    value: !0
  });
});