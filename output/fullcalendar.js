...
(function (t) {
    ...
    function o(n) {
      ...
      return o && t.each(o.split(" "), function () {
        ...
        t.each(this.split(","), function (n, r) {
          var l, a, c, d, h, u, g, m;
          "title" == r ? (o = o.add(t("<h2 class='title_calendar' >&nbsp;</h2>")), s = !1) : (e[r] ? l = function l() {
            e[r]();
          } : xe[r] && (l = function l() {
            e.changeView(r);
          }, p.push(r)), l && (a = S(i.themeButtonIcons, r), c = S(i.buttonIcons, r), d = S(i.defaultButtonText, r), h = S(i.buttonText, r), u = h ? R(h) : a && i.theme ? "<span class='ui-icon ui-icon-" + a + "'></span>" : c && !i.theme ? "<span style='color: #2C5E78;'  class='fc-icon fc-icon-" + c + "'></span>" : R(d || r), g = ["fc-" + r + "-button", f + "-button", f + "-state-default"], m = t('<button type="button" class="btn_prev_next">' + u + "</button>").click(function () {
  ...
  function c(e) {
    ...
    function o(i, n) {
      ...
      for (r = 0; l.length > r; r++) {
        ...
        if ("object" == _typeof(s)) return o(s, n), void 0;
      }
    ...
    function l(e) {
      ...
      if (t.isFunction(e) || t.isArray(e) ? i = {
        ...
        url: e
      } : "object" == _typeof(e) && (i = t.extend({}, e)), i) {
    ...
    function h(t) {
      return ("object" == _typeof(t) ? t.origArray || t.url || t.events : null) || t;
    }
    ...
    function f(t) {
      ...
      for (e = 0; A.length > e; e++) {
        if (i = A[e], i._id == t._id && i !== t) for (n = 0; V.length > n; n++) {
    ...
    function p(e) {
      ...
      for (null == e ? e = function e() {
        return !0;
      } : t.isFunction(e) || (i = e + "", e = function e(t) {
        return t._id == i;
  ...
  function ce(t, e, i) {
    var n,
        r = t.forwardSegs;
    if (void 0 === t.forwardCoord) for (r.length ? (r.sort(ue), ce(r[0], e + 1, i), t.forwardCoord = r[0].backwardCoord) : t.forwardCoord = 1, t.backwardCoord = t.forwardCoord - (t.forwardCoord - i) / (e + 1), n = 0; r.length > n; n++) {
  ...
  function fe(i) {
    ...
    function g(t, e) {
      var i = C.colCnt,
          n = N ? -1 : 1,
          r = N ? i - 1 : 0;
      "object" == _typeof(t) && (e = t.col, t = t.row);
      var o = t * i + (e * n + r);
      return o;
    }
    ...
    C.init(), C.getEventTimeText = function (t, e) {
      var r, o;
      return "object" == _typeof(t) && "object" == _typeof(e) ? (r = t, o = e, e = arguments[2]) : (r = t.start, o = t.end), e = e || n("timeFormat"), o && n("displayEventEnd") ? i.formatRange(r, o, e) : i.formatDate(r, e);
  ...
  j.prototype = {
    ...
    inBounds: function inBounds(t, e) {
    ...
    startListening: function startListening(e) {
      var i, n;
    ...
    stopListening: function stopListening(e) {
    ...
    dragScroll: function dragScroll(t) {
      var e,
          i,
          n,
          r,
    ...
    setScrollVel: function setScrollVel(e, i) {
    ...
    bookendCells: function bookendCells(t, e, i) {
      var n = this.view,
    ...
    getHtmlRenderer: function getHtmlRenderer(t, e) {
      var i,
          n,
          r,
          o,
    ...
    destroy: function destroy() {},
    buildCoords: function buildCoords() {},
    getCellDate: function getCellDate() {},
    getCellDayEl: function getCellDayEl() {},
    rangeToSegs: function rangeToSegs() {},
    ...
    destroyHelper: function destroyHelper() {},
    ...
    renderSegs: function renderSegs(e, i) {
      var n,
          r = this.view,
          o = "",
          s = [];
    ...
    renderSegHtml: function renderSegHtml() {},
    eventsToSegs: function eventsToSegs(e, i, n) {
      var r = this;
      return t.map(e, function (t) {
        return r.eventToSegs(t, i, n);
      });
    },
    eventToSegs: function eventToSegs(t, e, i) {
      var n,
          r,
          o,
    ...
    computeDraggedEventDates: function computeDraggedEventDates(t, e, i) {
      var n,
          r,
          o,
          s = this.view,
    ...
    segResizeMousedown: function segResizeMousedown(t, e) {
      function i() {
      ...
      n = new q(this.coordMap, {
        ...
        cellOver: function cellOver(e, n) {
    ...
    getSegClasses: function getSegClasses(t, e, i) {
      var n = t.event,
    ...
    getEventSkinCss: function getEventSkinCss(t) {
      var e = this.view,
          i = t.source || {},
          n = t.color,
          r = i.color,
    ...
    dayRowHtml: function dayRowHtml(t, e) {
      var i = this.view,
    ...
    dayCellHtml: function dayCellHtml(t, e, i) {
      return this.bgCellHtml(t, e, i);
    },
    buildCoords: function buildCoords(e, i) {
      var n,
          r,
          o,
          s = this.view.colCnt;
    ...
    getCellDate: function getCellDate(t) {
      return this.view.cellToDate(t);
    },
    getCellDayEl: function getCellDayEl(t) {
      return this.dayEls.eq(t.row * this.view.colCnt + t.col);
    },
    rangeToSegs: function rangeToSegs(t, e) {
      return this.view.rangeToSegments(t, e);
    },
    renderDrag: function renderDrag(t, e, i) {
      var n;
    ...
    renderResize: function renderResize(t, e, i) {
      this.renderHighlight(t, e), this.renderRangeHelper(t, e, i);
    },
    destroyResize: function destroyResize() {
      this.destroyHighlight(), this.destroyHelper();
    },
    renderHelper: function renderHelper(e, i) {
      var n = [],
    ...
    renderHighlight: function renderHighlight(e, i) {
      var n,
          r,
          o,
    ...
    highlightSkeletonHtml: function highlightSkeletonHtml(t, e) {
    ...
    segs: null,
    rowStructs: null,
    renderEvents: function renderEvents(e) {
    ...
    renderEventRows: function renderEventRows(t) {
      var e,
          i,
    ...
    renderSegHtml: function renderSegHtml(t, e) {
      var i,
          n = this.view,
          r = n.opt("isRTL"),
          o = t.event,
    ...
    renderEventRow: function renderEventRow(e, i) {
      function n(e) {
        for (; e > s;) {
    ...
    segPopover: null,
    popoverSegs: null,
    destroySegPopover: function destroySegPopover() {
    ...
    computeRowLevelLimit: function computeRowLevelLimit(t) {
      var e,
          i,
          n = this.rowEls.eq(t),
          r = n.height(),
    ...
    limitRow: function limitRow(e, i) {
      function n(n) {
        for (; n > T;) {
          r = {
            row: e,
        ...
        for (o = S.segLevels[i - 1], s = S.cellMatrix, l = S.tbodyEl.children().slice(i).addClass("fc-limited").get(), a = 0; o.length > a; a++) {
          ...
          if (h) {
            for (f = s[i - 1][c.leftCol], g = f.attr("rowspan") || 1, p = [], m = 0; u.length > m; m++) {
              v = t('<td class="fc-more-cell"/>').attr("rowspan", g), d = u[m], r = {
                row: e,
                col: c.leftCol + m
    ...
    renderMoreLink: function renderMoreLink(e, i) {
      var n = this,
          r = this.view;
    ...
    showSegPopover: function showSegPopover(t, e, i, n) {
      var r,
          o,
          s = this,
          l = this.view,
    ...
    renderSegPopoverContent: function renderSegPopoverContent(e, i) {
      var n,
          r = this.view,
          o = r.opt("theme"),
    ...
    resliceDaySegs: function resliceDaySegs(e, i) {
    ...
    getCellSegs: function getCellSegs(t, e) {
    ...
    slotBgCellHtml: function slotBgCellHtml(t, e, i) {
      return this.bgCellHtml(t, e, i);
    },
    ...
    buildCoords: function buildCoords(i, n) {
      var r,
          o,
          s = this.view.colCnt,
    ...
    computeDateTop: function computeDateTop(t, i) {
    ...
    renderHelper: function renderHelper(e, i) {
      ...
      for (n = 0; a.length > n; n++) {
        r = a[n], i && i.col === r.col && (o = i.el, r.el.css({
          left: o.css("left"),
          right: o.css("right"),
    ...
    renderEventTable: function renderEventTable(e) {
      var i,
          n,
          r,
          o,
    ...
    updateSegVerticals: function updateSegVerticals() {
      var t,
          e = this.segs;
      if (e) for (this.computeSegVerticals(e), t = 0; e.length > t; t++) {
    ...
    generateSegPositionCss: function generateSegPositionCss(t) {
      var e,
          i,
          n = this.view,
          r = n.opt("isRTL"),
    ...
    groupSegCols: function groupSegCols(t) {
      var e,
          i = this.view,
          n = [];
    ...
    resolveEventEl: function resolveEventEl(e, i) {
    ...
    renderDrag: function renderDrag() {},
    destroyDrag: function destroyDrag() {},
    documentDragStart: function documentDragStart(e) {
      var i,
          n = this,
          r = null;
      this.opt("droppable") && (i = new q(this.coordMap, {
        cellOver: function cellOver(t, e) {
          r = e, n.renderDrag(e);
        },
        cellOut: function cellOut() {
    ...
    reportSelection: function reportSelection(t, e, i) {
    ...
    numberIntroHtml: function numberIntroHtml(t) {
    ...
    numberCellHtml: function numberCellHtml(t, e, i) {
      var n;
    ...
    name: "month",
    incrementDate: function incrementDate(t, e) {
